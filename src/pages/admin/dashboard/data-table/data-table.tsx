...
export function DataTable({
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (active && over && active.id !== over.id) {
      setDataTable((prev: any) => {
        const oldIndex = prev.data.findIndex(
          (item: any) => item.id === active.id
        );
        const newIndex = prev.data.findIndex(
  ...
  return (
    // tabs to choose show table content
    <Tabs
      defaultValue="outline"
      onValueChange={setDataTable}
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline" onValueChange={setDataTable}>
          <SelectTrigger
          ...
          <SelectContent>
            <SelectItem value="outline">Outline2</SelectItem>
